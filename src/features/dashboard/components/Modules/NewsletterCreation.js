...
import { ArrowLeft, Eye, Image as ImageIcon, Mail, Palette, PenTool, Save, Send, Users } from 'lucide-react';
...
export function NewsletterCreation({ onBack, editingNewsletter }) {
    ...
    const renderTemplateStep = () => {
        ...
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Choose a Template" }), _jsx("p", { className: "text-gray-600 mb-8", children: "Select a template that matches your newsletter style" })] }), _jsx("div", { className: "flex justify-center mb-6 gap-2 flex-wrap px-2", children: categories.map(cat => (_jsx("button", { className: `px-4 py-2 rounded-full border ${templateCategory === cat ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-700 border-gray-300'} transition`, onClick: () => setTemplateCategory(cat), children: cat.charAt(0).toUpperCase() + cat.slice(1) }, cat))) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 md:overflow-visible overflow-x-auto snap-x snap-mandatory pb-2 -mx-3 px-3", children: filteredTemplates.map((template) => (_jsxs("div", { className: "md:border md:border-gray-200 rounded-none md:rounded-lg overflow-hidden cursor-pointer hover:md:shadow-lg transition relative bg-white md:bg-white snap-center min-w-full md:min-w-0", children: [_jsxs("div", { className: "h-48 bg-gray-100 flex items-center justify-center", onClick: () => setPreviewTemplate(template), children: [_jsx("img", { src: template.thumbnail, alt: template.name, className: "w-full h-full object-contain md:object-cover" }), _jsx("span", { className: "absolute top-2 right-2 bg-white bg-opacity-80 px-2 py-1 rounded text-xs shadow", children: "Preview" })] }), _jsxs("div", { className: "p-3 md:p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("h3", { className: "font-semibold text-gray-900", children: template.name }), _jsx("span", { className: "text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full", children: template.category })] }), _jsx("p", { className: "text-sm text-gray-600", children: template.description }), _jsx("button", { className: "mt-3 w-full bg-blue-600 text-white rounded px-3 py-3 md:py-2 hover:bg-blue-700 transition", onClick: () => handleTemplateSelect(template), children: "Select" })] })] }, template.id))) }), previewTemplate && (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4", children: _jsxs("div", { className: "bg-white rounded-lg max-w-2xl w-full p-4 md:p-6 relative", children: [_jsx("button", { className: "absolute top-2 right-2 text-gray-500 hover:text-gray-700", onClick: () => setPreviewTemplate(null), children: "\u00D7" }), _jsx("h3", { className: "text-xl font-bold mb-2", children: previewTemplate.name }), _jsx("div", { className: "mb-2 text-gray-600", children: previewTemplate.description }), _jsx("div", { className: "mb-4", children: _jsx("span", { className: "text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded-full", children: previewTemplate.category }) }), _jsx("div", { className: "border rounded p-2 md:p-4 bg-gray-50 mb-4 overflow-x-hidden", dangerouslySetInnerHTML: { __html: previewTemplate.htmlContent.replace('{{TITLE}}', 'Sample Title').replace('{{CONTENT}}', 'Sample content...') } }), _jsx("button", { className: "w-full bg-blue-600 text-white rounded px-3 py-2 hover:bg-blue-700 transition", onClick: () => { handleTemplateSelect(previewTemplate); setPreviewTemplate(null); }, children: "Use This Template" })] }) }))] }));
    };
    const renderContentStep = () => {
        ...
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Create Your Content" }), _jsx("p", { className: "text-gray-600 mb-8", children: "Add your newsletter content and details" })] }), _jsx("div", { className: "flex justify-end", children: _jsx("button", { className: "text-sm text-blue-600", onClick: () => setSimpleMode(true), children: "Switch to Simple Mode" }) }), _jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Add Your Content" }), _jsx("p", { className: "text-gray-600 mb-8", children: "Fill in the fields; no dragging needed" })] }), _jsxs("div", { className: "bg-white md:border rounded-lg p-4 space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Title" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.title, onChange: (e) => setNewsletterData(prev => ({ ...prev, title: e.target.value })), placeholder: "Newsletter title" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Subject" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.subject, onChange: (e) => setNewsletterData(prev => ({ ...prev, subject: e.target.value })), placeholder: "Email subject" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Preheader (optional)" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.preheader, onChange: (e) => setNewsletterData(prev => ({ ...prev, preheader: e.target.value })), placeholder: "Short preview text" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Main Content" }), _jsx("textarea", { className: "w-full px-3 py-2 border rounded", rows: 6, value: newsletterData.content, onChange: (e) => setNewsletterData(prev => ({ ...prev, content: e.target.value })), placeholder: "Write your newsletter..." })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Header Image URL" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.customizations.headerImage || '', onChange: (e) => setNewsletterData(prev => ({ ...prev, customizations: { ...prev.customizations, headerImage: e.target.value } })), placeholder: "https://..." })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Background Image URL" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.customizations.backgroundImage || '', onChange: (e) => setNewsletterData(prev => ({ ...prev, customizations: { ...prev.customizations, backgroundImage: e.target.value } })), placeholder: "https://..." })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "CTA Button Text" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: blocks.find(b => b.type === 'button')?.content || '', onChange: (e) => {
                                                    ...
                                                    }, placeholder: "Buy now" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "CTA Button URL" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: blocks.find(b => b.type === 'button')?.styles?.url || '', onChange: (e) => {
                                                        const existing = blocks.find(b => b.type === 'button');
                                                        if (existing) {
                                                    ...
                                                    }, placeholder: "https://..." })] })] })] }), _jsxs("div", { className: "hidden md:flex justify-between sticky bottom-0 bg-white/80 backdrop-blur-md py-3", children: [_jsxs(Button, { variant: "outline", onClick: () => setCurrentStep('template'), children: [_jsx(ArrowLeft, { className: "w-4 h-4 mr-2" }), "Back to Templates"] }), _jsxs("div", { className: "space-x-4", children: [_jsxs(Button, { variant: "outline", onClick: handleSaveDraft, disabled: loading, children: [_jsx(Save, { className: "w-4 h-4 mr-2" }), "Save Draft"] }), _jsx(Button, { onClick: () => setCurrentStep('design'), disabled: !newsletterData.title || !newsletterData.content, children: "Next: Design" })] })] })] })] }));
    };
    const renderSimpleContentStep = () => {
        // Simple mode: form fields mapped to template placeholders
        return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Add Your Content" }), _jsx("p", { className: "text-gray-600 mb-8", children: "Fill in the fields; no dragging needed" })] }), _jsx("div", { className: "bg-white md:border md:rounded-lg p-4 -mx-3 md:mx-0 rounded-none", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Title" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.title, onChange: (e) => setNewsletterData(prev => ({ ...prev, title: e.target.value })), placeholder: "Newsletter title" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Subject" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.subject, onChange: (e) => setNewsletterData(prev => ({ ...prev, subject: e.target.value })), placeholder: "Email subject" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Preheader (optional)" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.preheader, onChange: (e) => setNewsletterData(prev => ({ ...prev, preheader: e.target.value })), placeholder: "Short preview text" })] })] }) }), _jsxs("div", { className: "bg-white md:border md:rounded-lg p-4 space-y-4 -mx-3 md:mx-0 rounded-none", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Header Image URL" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.customizations.headerImage || '', onChange: (e) => setNewsletterData(prev => ({ ...prev, customizations: { ...prev.customizations, headerImage: e.target.value } })), placeholder: "https://..." })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Background Image URL" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: newsletterData.customizations.backgroundImage || '', onChange: (e) => setNewsletterData(prev => ({ ...prev, customizations: { ...prev.customizations, backgroundImage: e.target.value } })), placeholder: "https://..." })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "CTA Button Text" }), _jsx("input", { type: "text", className: "w-full px-3 py-2 border rounded", value: blocks.find(b => b.type === 'button')?.content || '', onChange: (e) => {
                                                const existing = blocks.find(b => b.type === 'button');
                                                if (existing) {
                                                    setBlocks(prev => prev.map(b => b.id === existing.id ? { ...b, content: e.target.value } : b));
                                                }
    ...
    const renderDesignStep = () => (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-3xl font-bold text-gray-900 mb-4", children: "Customize Design" }), _jsx("p", { className: "text-gray-600 mb-8", children: "Personalize colors and styling" })] }), _jsx("div", { className: "flex justify-end", children: _jsx("button", { className: "text-sm text-blue-600", onClick: () => setSimpleMode(!simpleMode), children: simpleMode ? 'Switch to Advanced Mode' : 'Switch to Simple Mode' }) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8", children: [_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-2", children: "Primary Color" }), _jsx("input", { type: "color", value: newsletterData.customizations.primaryColor, onChange: (e) => setNewsletterData(prev => ({
                                                    ...prev,
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50 overflow-x-hidden", children: [_jsx("div", { className: "bg-white border-b border-gray-200 px-4 md:px-6 py-3 md:py-4", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center", children: [_jsx(Button, { variant: "outline", onClick: onBack, className: "mr-4", children: _jsx(ArrowLeft, { className: "w-4 h-4" }) }), _jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Create Newsletter" })] }), _jsx("div", { className: "flex items-center space-x-2", children: _jsx("div", { className: "flex items-center space-x-1", children: ['template', 'content', 'design', 'preview'].map((step, index) => (_jsx("div", { className: `w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium ${['template', 'content', 'design', 'preview'].indexOf(currentStep) >= index
                                        ? 'bg-blue-600 text-white'
                                        : 'bg-gray-200 text-gray-600'}`, children: index + 1 }, step))) }) })] }) }), _jsxs("div", { className: "max-w-7xl mx-auto px-3 md:px-6 py-6 md:py-8", children: [loading && (_jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: _jsxs("div", { className: "bg-white p-6 rounded-lg", children: [_jsx(LoadingSpinner, { size: "lg" }), _jsx("p", { className: "mt-4 text-center", children: "Processing..." })] }) })), currentStep === 'template' && renderTemplateStep(), currentStep === 'content' && (simpleMode ? renderSimpleContentStep() : renderContentStep()), currentStep === 'design' && renderDesignStep(), currentStep === 'preview' && renderPreviewStep()] }), _jsx(MobileBottomWizard, { currentStep: currentStep, steps: steps, onStep: (s) => setCurrentStep(s), onNext: () => {
                    const idx = steps.indexOf(currentStep);
                    if (currentStep === 'template' && !selectedTemplate)
                        return;
                    if (currentStep === 'content' && (!newsletterData.title || !newsletterData.content))
                        return;
                    if (idx < steps.length - 1)
                        setCurrentStep(steps[idx + 1]);
                    else
                        handleSendNewsletter();
                } }), _jsx("div", { className: "h-16 md:h-0" })] }));
}
export default NewsletterCreation;
function MobileBottomWizard({ currentStep, steps, onStep, onNext, }) {
    const idx = steps.indexOf(currentStep);
    const progress = Math.max(0, Math.min(100, ((idx + 1) / steps.length) * 100));
    const labelFor = (s) => s === 'template' ? 'Templates' : s.charAt(0).toUpperCase() + s.slice(1);
    return (_jsx("div", { className: "fixed bottom-0 inset-x-0 z-50 md:hidden supports-[backdrop-filter]:bg-white/80 dark:bg-slate-900/80 backdrop-blur border-t border-slate-200 dark:border-slate-700 shadow-md rounded-t-2xl px-2 pt-1.5 pb-[max(env(safe-area-inset-bottom),0.25rem)]", children: _jsxs("div", { className: "relative max-w-3xl mx-auto", children: [_jsx("div", { className: "absolute -top-1.5 left-1/2 -translate-x-1/2 w-28 h-1 rounded-full overflow-hidden bg-gradient-to-r from-slate-200/70 to-slate-300/70 dark:from-slate-700/70 dark:to-slate-600/70", children: _jsx("div", { className: "h-full bg-gradient-to-r from-blue-500 via-fuchsia-500 to-emerald-500", style: { width: `${progress}%` } }) }), _jsxs("div", { className: "flex items-center justify-between gap-2", children: [_jsx("div", { className: "flex flex-1 items-center justify-between gap-1.5", children: steps.map((s) => {
                                ...
                                return (_jsxs("button", { onClick: () => onStep(s), "aria-current": active ? 'step' : undefined, className: `flex flex-col items-center flex-1 min-w-0 px-0.5 py-1 ${active ? 'text-slate-900 dark:text-white' : 'text-slate-500 dark:text-slate-300'}`, children: [_jsx("div", { className: `w-8 h-8 rounded-full flex items-center justify-center transition-all shadow ${color}`, children: _jsx(Icon, { className: "w-4 h-4" }) }), _jsx("span", { className: "mt-0.5 text-[10px] font-medium truncate", children: labelFor(s) })] }, s));
                            }) }), _jsxs("button", { onClick: onNext, className: "ml-2 shrink-0 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow flex items-center", children: [_jsx("span", { className: "mr-1.5 text-sm", children: currentStep === 'preview' ? 'Send' : 'Next' }), currentStep === 'preview' ? _jsx(Send, { className: "w-3.5 h-3.5" }) : _jsx(Eye, { className: "w-3.5 h-3.5" })] })] })] }) }));
}
