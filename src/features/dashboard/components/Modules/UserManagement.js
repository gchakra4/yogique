...
export function UserManagement() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsx("div", { className: "flex justify-between items-center", children: _jsxs("h2", { className: "text-2xl font-bold text-gray-900 flex items-center", children: [_jsx(Users, { className: "w-6 h-6 mr-2" }), "User Management (", users.length, ")"] }) }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-6", children: [_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6 text-center", children: [_jsx("div", { className: "text-3xl font-bold text-blue-600 mb-2", children: users.length }), _jsx("div", { className: "text-gray-600", children: "Total Users" })] }), _jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6 text-center", children: [_jsx("div", { className: "text-3xl font-bold text-green-600 mb-2", children: users.filter(u => u.user_roles?.includes('instructor')).length }), _jsx("div", { className: "text-gray-600", children: "Instructors" })] }), _jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6 text-center", children: [_jsx("div", { className: "text-3xl font-bold text-purple-600 mb-2", children: users.filter(u => u.user_roles?.includes('yoga_acharya')).length }), _jsx("div", { className: "text-gray-600", children: "Yoga Acharyas" })] }), _jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6 text-center", children: [_jsx("div", { className: "text-3xl font-bold text-red-600 mb-2", children: users.filter(u => u.user_roles?.some(role => ['admin', 'super_admin'].includes(role))).length }), _jsx("div", { className: "text-gray-600", children: "Admins" })] })] }), _jsx("div", { className: "bg-white rounded-xl shadow-lg p-6", children: _jsxs("div", { className: "flex flex-col md:flex-row gap-4", children: [_jsx("div", { className: "flex-1", children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" }), _jsx("input", { type: "text", placeholder: "Search by name or email...", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), className: "w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" })] }) }), _jsx("div", { children: _jsxs("div", { className: "relative", children: [_jsx(Filter, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" }), _jsxs("select", { value: roleFilter, onChange: (e) => setRoleFilter(e.target.value), className: "pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white", children: [_jsx("option", { value: "all", children: "All Roles" }), _jsx("option", { value: "user", children: "Users" }), _jsx("option", { value: "instructor", children: "Instructors" }), _jsx("option", { value: "yoga_acharya", children: "Yoga Acharyas" }), _jsx("option", { value: "mantra_curator", children: "Mantra Curators" }), _jsx("option", { value: "admin", children: "Admins" }), _jsx("option", { value: "super_admin", children: "Super Admins" })] })] }) })] }) }), _jsxs("div", { className: "bg-white rounded-xl shadow-lg overflow-hidden", children: [_jsxs("div", { className: "p-2 sm:hidden divide-y divide-gray-200", children: [filteredUsers.length === 0 ? (_jsxs("div", { className: "text-center py-6", children: [_jsx(Users, { className: "w-12 h-12 text-gray-400 mx-auto mb-2" }), _jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-1", children: "No users found" }), _jsx("p", { className: "text-gray-600 text-sm", children: "Try adjusting your search or filter criteria." })] })) : (visibleUsers.map((user) => (_jsxs("div", { className: "py-3 flex flex-col sm:flex-row items-start sm:items-center justify-between", children: [_jsxs("div", { className: "flex items-start gap-3 w-full", children: [_jsx("div", { className: "w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0", children: _jsx(User, { className: "w-5 h-5 text-blue-600" }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("div", { className: "text-sm font-medium text-gray-900 truncate", children: user.full_name || 'No name' }), _jsx("div", { className: "text-sm text-gray-500 truncate", children: user.email }), user.user_roles && user.user_roles.length > 0 && (_jsx("div", { className: "mt-2 flex flex-wrap gap-1", children: user.user_roles.map((role, idx) => (_jsx("span", { className: `px-2 py-1 text-xs rounded-full ${getRoleColor(role)}`, children: role.replace('_', ' ') }, idx))) }))] })] }), _jsxs("div", { className: "w-full sm:w-auto mt-3 sm:mt-0 sm:ml-4 flex-shrink-0", children: [_jsx("div", { className: "sm:hidden", children: _jsx(IconCircleButton, { "aria-label": `Manage roles for ${user.full_name || user.email}`, onClick: () => {
                                                        setSelectedUser(user);
                                                        setShowRoleManagement(true);
                                                    }, children: _jsx(Shield, { className: "w-6 h-6", fill: "currentColor", strokeWidth: 0 }) }) }), _jsx("div", { className: "hidden sm:block", children: _jsxs(ResponsiveActionButton, { onClick: () => { setSelectedUser(user); setShowRoleManagement(true); }, size: "sm", variant: "outline", className: "flex items-center", children: [_jsx(Shield, { className: "w-4 h-4 mr-1 text-emerald-600 dark:text-emerald-300", fill: "currentColor", strokeWidth: 0 }), "Manage Roles"] }) })] })] }, user.user_id)))), filteredUsers.length > VISIBLE_LIMIT && (_jsx("div", { className: "py-3 text-center", children: _jsx("button", { className: "text-sm text-emerald-600 hover:underline", onClick: () => setShowAllUsers(prev => !prev), children: showAllUsers ? 'Show less' : `Show more (${filteredUsers.length - VISIBLE_LIMIT} more)` }) }))] }), _jsx("div", { className: "hidden sm:block overflow-x-auto", children: filteredUsers.length === 0 ? (_jsxs("div", { className: "text-center py-12", children: [_jsx(Users, { className: "w-16 h-16 text-gray-400 mx-auto mb-4" }), _jsx("h3", { className: "text-lg font-semibold text-gray-900 mb-2", children: "No users found" }), _jsx("p", { className: "text-gray-600", children: "Try adjusting your search or filter criteria." })] })) : (_jsxs(_Fragment, { children: [_jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "User" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Roles" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Joined" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Actions" })] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: visibleUsers.map((user) => (_jsxs("tr", { className: "hover:bg-gray-50", children: [_jsx("td", { className: "px-6 py-4", children: _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-4", children: _jsx(User, { className: "w-5 h-5 text-blue-600" }) }), _jsxs("div", { children: [_jsx("div", { className: "text-sm font-medium text-gray-900", children: user.full_name || 'No name' }), _jsx("div", { className: "text-sm text-gray-500", children: user.email }), user.phone && _jsx("div", { className: "text-xs text-gray-400", children: user.phone })] })] }) }), _jsx("td", { className: "px-6 py-4", children: _jsx("div", { className: "flex flex-wrap gap-1", children: user.user_roles && user.user_roles.length > 0 ? (user.user_roles.map((role, index) => (_jsx("span", { className: `px-2 py-1 text-xs rounded-full ${getRoleColor(role)}`, children: role.replace('_', ' ') }, index)))) : (_jsx("span", { className: "px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-800", children: "user" })) }) }), _jsx("td", { className: "px-6 py-4 text-sm text-gray-500", children: formatDate(user.created_at) }), _jsx("td", { className: "px-6 py-4", children: _jsxs(ResponsiveActionButton, { onClick: () => { setSelectedUser(user); setShowRoleManagement(true); }, size: "sm", variant: "outline", className: "flex items-center", children: [_jsx(Shield, { className: "w-4 h-4 mr-1 text-emerald-600 dark:text-emerald-300", fill: "currentColor", strokeWidth: 0 }), "Manage Roles"] }) })] }, user.user_id))) })] }), filteredUsers.length > VISIBLE_LIMIT && (_jsx("div", { className: "p-4 text-center", children: _jsx("button", { className: "text-sm text-emerald-600 hover:underline", onClick: () => setShowAllUsers(prev => !prev), children: showAllUsers ? 'Show less' : `Show more (${filteredUsers.length - VISIBLE_LIMIT} more)` }) }))] })) })] })] }));
}
