...
const InstructorRatesPage = () => {
    ...
    return (_jsxs("div", { className: "px-4 sm:p-6 bg-white rounded-lg", children: [_jsx("h1", { className: "text-2xl sm:text-3xl font-extrabold text-blue-800 mb-3", children: "Manage Standard Rates" }), _jsx("p", { className: "text-gray-700 mb-4", children: "Set generic rates by schedule type and category that can be applied to any instructor during class assignment." }), !showForm && (_jsx("div", { className: "sm:hidden w-full flex justify-center mb-4", children: _jsxs(ResponsiveActionButton, { onClick: () => { setShowForm(true); setEditingRate(undefined); }, className: "inline-flex items-center px-4 py-2 text-sm bg-indigo-600 text-white", children: [_jsx(Plus, { className: "w-4 h-4 mr-2" }), "Add Rate"] }) })), _jsx("div", { className: "mb-8 hidden sm:block", children: _jsxs("div", { className: "bg-white p-4 rounded-lg shadow-md", children: [_jsx("h2", { className: "text-2xl font-semibold text-indigo-700 mb-4", children: editingRate ? 'Edit Rate' : 'Add New Rate' }), _jsx(InstructorRateForm, { onSubmit: handleSubmit, existingRate: editingRate })] }) }), showForm && (_jsx("div", { className: "mb-6 sm:hidden", children: _jsxs("div", { className: "bg-white p-4 rounded-lg shadow-md", children: [_jsxs("div", { className: "flex justify-between items-center mb-3", children: [_jsx("h2", { className: "text-lg font-semibold text-indigo-700", children: editingRate ? 'Edit Rate' : 'Add New Rate' }), _jsx("button", { className: "text-gray-500", onClick: () => { setShowForm(false); setEditingRate(undefined); }, children: "Close" })] }), _jsx(InstructorRateForm, { onSubmit: async (data) => { await handleSubmit(data); setShowForm(false); }, existingRate: editingRate })] }) })), _jsxs("div", { className: "sm:bg-white sm:p-4 sm:rounded-lg", children: [_jsx("h2", { className: "text-2xl font-semibold text-indigo-700 mb-4", children: "Current Standard Rates" }), _jsxs("div", { className: "divide-y divide-gray-100", children: [rates.map((rate) => (_jsxs("div", { className: "p-4 sm:p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center w-full", children: [_jsxs("div", { children: [_jsxs("p", { className: "font-bold text-lg text-gray-800", children: [rate.class_types ? `${rate.class_types.name} (${rate.class_types.difficulty_level})` :
