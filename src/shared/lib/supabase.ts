...
const runtimeUrl = (typeof window !== 'undefined' && ((window as any).SUPABASE_URL || runtimeConfig.SUPABASE_URL))
const runtimeAnon = (typeof window !== 'undefined' && ((window as any).SUPABASE_ANON_KEY || runtimeConfig.SUPABASE_ANON_KEY))
