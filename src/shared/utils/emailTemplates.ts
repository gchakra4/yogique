...
const modernGradientTemplate = (vars: EmailTemplateVariables): string => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const minimalCleanTemplate = (vars: EmailTemplateVariables): string => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const corporateProfessionalTemplate = (vars: EmailTemplateVariables): string => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const imageFocusedTemplate = (vars: EmailTemplateVariables): string => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
const socialModernTemplate = (vars: EmailTemplateVariables): string => `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
